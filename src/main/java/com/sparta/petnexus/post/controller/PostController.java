...
public class PostController {
    ...
    public ResponseEntity<ApiResponse> updatePost(
            @Parameter(name="postId",description = "특정 post id",in= ParameterIn.PATH) @PathVariable Long postId, @ModelAttribute(value = "requestDto") PostRequestDto postRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails) {
